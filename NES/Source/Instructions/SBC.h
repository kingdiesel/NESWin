...
typedef BaseInstruction<SBCBase<ImmediateAddressingStrategy>, 0xE9, 2> SBCImmediate;
typedef BaseInstruction<SBCBase<AbsoluteAddressingStrategy>, 0xED, 4> SBCAbsolute;
typedef BaseInstruction<SBCBase<AbsoluteXAddressingStrategy>, 0xFD, 4> SBCAbsoluteX;
typedef BaseInstruction<SBCBase<AbsoluteYAddressingStrategy>, 0xF9, 4> SBCAbsoluteY;
typedef BaseInstruction<SBCBase<ZeroPageAddressingStrategy>, 0xE5, 3> SBCZeroPage;
typedef BaseInstruction<SBCBase<ZeroPageXAddressingStrategy>, 0xF5, 4> SBCZeroPageX;
typedef BaseInstruction<SBCBase<IndexedIndirectAddressingStrategy>, 0xE1, 6> SBCIndexedIndirect;
typedef BaseInstruction<SBCBase<IndirectIndexedAddressingStrategy>, 0xF1, 5> SBCIndirectIndexed;
