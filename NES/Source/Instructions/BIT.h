...
typedef BaseInstruction<BITBase<AbsoluteAddressingStrategy>, 0x2C, 4> BITAbsolute;
typedef BaseInstruction<BITBase<ZeroPageAddressingStrategy>, 0x24, 3> BITZeroPage;
